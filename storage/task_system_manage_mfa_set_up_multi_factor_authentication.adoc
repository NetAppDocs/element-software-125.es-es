...
+
Los metadatos del IdP, en formato de texto sin formato, se obtienen del IdP de terceros. Estos metadatos deben validarse para garantizar que tengan el formato JSON correcto. Existen numerosas aplicaciones de formateo de JSON que puedes utilizar, por ejemplo:https://freeformatter.com/json-escape.html.
